...
class Delete_Supplier:
    def __init__(self,FindID):
        self.findid = FindID
        self.findid.title("Delete Supplier Record")
...
def run_delete_supplier():
    delete_supplier1 = Tk()
    Delete_Supplier(delete_supplier1)
    delete_supplier1.geometry("600x600+50+50")
    delete_supplier1.mainloop()

...
class Modify_Purchase:
    def __init__(self,FindID):
        self.findid = FindID
        self.findid.title("Modify Purchase")
...
def run_modify_purchase():
    modify_purchase1 = Tk()
    Modify_Purchase(modify_purchase1)
    modify_purchase1.geometry("600x600+50+50")
    modify_purchase1.mainloop()

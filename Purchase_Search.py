...
class Purchase_search:
    def __init__(self,FindID):
        self.findid = FindID
        self.findid.title("Purchase Search")
        ...
        self.label3 = Label(self.frame1, text="Supplier Contact Number : ")
...
def run_purchase_search():
    purchase1 = Tk()
    Purchase_search(purchase1)
    purchase1.geometry("600x600+50+50")
    purchase1.mainloop()

...
class Delete_Sale:
    def __init__(self,FindID):
        self.findid = FindID
        self.findid.title("Delete Sale Record")
        self.suppframe = Frame(self.findid,relief=RAISED,borderwidth=1,pady=20)

        #add supplier id Label
        self.suppid = Label(self.suppframe,text="Bill Number : ",padx=10,pady=10)
        ...
        self.label0 = Label(self.frame1, text="Bill Number : ")
        self.label0.config(font=('ariel', 12, 'bold'))
        self.label1 = Label(self.frame1, text="Customer Name : ")
        ...
        # add Delete button
        self.findbutton = Button(self.frame1, text="Delete", padx=30, command=quit)
...
def run_delete_sale():
    delete_sale1 = Tk()
    Delete_Sale(delete_sale1)
    delete_sale1.geometry("600x600+50+50")
    delete_sale1.mainloop()
